...
Use image revision tags such as `wodby/redis:8-rN` to select a Wodby image revision.
Major and minor tags use the repository release number. Full-version tags such as
`wodby/redis:8.6.6-r0` start at `r0` for each exact upstream version.
...
See [release tags](https://github.com/wodby/redis/tags) for available revisions and the [image revision policy](https://github.com/wodby/images#image-revisions) for upgrade guidance.
